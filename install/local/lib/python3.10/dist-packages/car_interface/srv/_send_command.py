...
class SendCommand_Request(metaclass=Metaclass_SendCommand_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.hex_command = kwargs.get('hex_command', str())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.hex_command != other.hex_command:
            return False
        return True
    ...
    @builtins.property
    def hex_command(self):
        """Message field 'hex_command'."""
        return self._hex_command

    @hex_command.setter
    def hex_command(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'hex_command' field must be of type 'str'"
        self._hex_command = value
...
class Metaclass_SendCommand(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from car_interface.srv import _send_command
...
class SendCommand(metaclass=Metaclass_SendCommand):
    from car_interface.srv._send_command import SendCommand_Request as Request
    from car_interface.srv._send_command import SendCommand_Response as Response

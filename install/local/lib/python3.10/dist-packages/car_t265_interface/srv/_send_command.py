...
class Metaclass_SendCommand(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'car_t265_interface.srv.SendCommand')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from car_t265_interface.srv import _send_command
...
class SendCommand(metaclass=Metaclass_SendCommand):
    from car_t265_interface.srv._send_command import SendCommand_Request as Request
    from car_t265_interface.srv._send_command import SendCommand_Response as Response

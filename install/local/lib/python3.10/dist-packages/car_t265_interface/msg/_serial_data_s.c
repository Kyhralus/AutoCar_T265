...
bool car_t265_interface__msg__serial_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("car_t265_interface.msg._serial_data.SerialData", full_classname_dest, 46) == 0);
  }
  car_t265_interface__msg__SerialData * ros_message = _ros_message;
  {  // data
...
PyObject * car_t265_interface__msg__serial_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("car_t265_interface.msg._serial_data");

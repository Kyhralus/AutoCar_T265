...
#ifndef CAR_T265_INTERFACE__MSG__DETAIL__T265_DATA__STRUCT_HPP_
#define CAR_T265_INTERFACE__MSG__DETAIL__T265_DATA__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__car_t265_interface__msg__T265Data __attribute__((deprecated))
#else
# define DEPRECATED__car_t265_interface__msg__T265Data __declspec(deprecated)
#endif
...
struct T265Data_
{
  ...
  // pointer types
  using RawPtr =
    car_t265_interface::msg::T265Data_<ContainerAllocator> *;
  using ConstRawPtr =
    const car_t265_interface::msg::T265Data_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<car_t265_interface::msg::T265Data_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<car_t265_interface::msg::T265Data_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      car_t265_interface::msg::T265Data_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<car_t265_interface::msg::T265Data_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<car_t265_interface::msg::T265Data_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<car_t265_interface::msg::T265Data_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<car_t265_interface::msg::T265Data_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__car_t265_interface__msg__T265Data
    std::shared_ptr<car_t265_interface::msg::T265Data_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__car_t265_interface__msg__T265Data
    std::shared_ptr<car_t265_interface::msg::T265Data_<ContainerAllocator> const>
...
using T265Data =
  car_t265_interface::msg::T265Data_<std::allocator<void>>;
...
#endif  // CAR_T265_INTERFACE__MSG__DETAIL__T265_DATA__STRUCT_HPP_

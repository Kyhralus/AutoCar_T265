...
#ifndef CAR_T265_INTERFACE__SRV__DETAIL__SEND_COMMAND__FUNCTIONS_H_
#define CAR_T265_INTERFACE__SRV__DETAIL__SEND_COMMAND__FUNCTIONS_H_
 ...
 * calls
 * car_t265_interface__srv__SendCommand_Request__init().
...
/**
 * It calls
 * car_t265_interface__srv__SendCommand_Request__fini()
 ...
 * car_t265_interface__srv__SendCommand_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * car_t265_interface__srv__SendCommand_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * car_t265_interface__srv__SendCommand_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_car_t265_interface
...
/**
 * It calls
 * car_t265_interface__srv__SendCommand_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_car_t265_interface
...
/**
 * It allocates the memory for the array and calls
 * car_t265_interface__srv__SendCommand_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_car_t265_interface
...
/**
 * It calls
 * car_t265_interface__srv__SendCommand_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CAR_T265_INTERFACE__SRV__DETAIL__SEND_COMMAND__FUNCTIONS_H_

...
bool car_interface__msg__t265_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("car_interface.msg._t265_data.T265Data", full_classname_dest, 37) == 0);
  }
  car_interface__msg__T265Data * ros_message = _ros_message;
  {  // pos_x
...
PyObject * car_interface__msg__t265_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("car_interface.msg._t265_data");

...
#include "car_interface/msg/detail/t265_data__rosidl_typesupport_fastrtps_c.h"
...
using _T265Data__ros_msg_type = car_interface__msg__T265Data;
...
size_t get_serialized_size_car_interface__msg__T265Data(
  const void * untyped_ros_message,
...
static uint32_t _T265Data__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_car_interface__msg__T265Data(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_car_interface
size_t max_serialized_size_car_interface__msg__T265Data(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = car_interface__msg__T265Data;
    is_plain =
      (
...
static size_t _T265Data__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_car_interface__msg__T265Data(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, car_interface, msg, T265Data)() {

...
#include "car_interface/msg/detail/t265_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const car_interface::msg::T265Data & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  car_interface::msg::T265Data & ros_message)
{
  // Member: pos_x
  cdr >> ros_message.pos_x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = car_interface::msg::T265Data;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const car_interface::msg::T265Data *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<car_interface::msg::T265Data *>(
    untyped_ros_message);
...
{
  return &car_interface::msg::typesupport_fastrtps_cpp::_T265Data__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, car_interface, msg, T265Data)() {
  return &car_interface::msg::typesupport_fastrtps_cpp::_T265Data__handle;
}

...
#include "car_interface/msg/detail/motor_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const car_interface::msg::MotorCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  car_interface::msg::MotorCommand & ros_message)
{
  // Member: command
  cdr >> ros_message.command;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = car_interface::msg::MotorCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const car_interface::msg::MotorCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<car_interface::msg::MotorCommand *>(
    untyped_ros_message);
...
{
  return &car_interface::msg::typesupport_fastrtps_cpp::_MotorCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, car_interface, msg, MotorCommand)() {
  return &car_interface::msg::typesupport_fastrtps_cpp::_MotorCommand__handle;
}

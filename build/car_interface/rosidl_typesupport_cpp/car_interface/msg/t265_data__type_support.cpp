...
static const _T265Data_type_support_symbol_names_t _T265Data_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, car_interface, msg, T265Data)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, car_interface, msg, T265Data)),
  }
};
...
{
  return &::car_interface::msg::rosidl_typesupport_cpp::T265Data_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, car_interface, msg, T265Data)() {
  return get_message_type_support_handle<car_interface::msg::T265Data>();
}

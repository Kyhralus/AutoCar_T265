...
car_t265_interface__msg__T265Data__create()
{
  ...
  car_t265_interface__msg__T265Data * msg = (car_t265_interface__msg__T265Data *)allocator.allocate(sizeof(car_t265_interface__msg__T265Data), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(car_t265_interface__msg__T265Data));
  bool success = car_t265_interface__msg__T265Data__init(msg);
  if (!success) {
...
car_t265_interface__msg__T265Data__destroy(car_t265_interface__msg__T265Data * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    car_t265_interface__msg__T265Data__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
car_t265_interface__msg__T265Data__Sequence__init(car_t265_interface__msg__T265Data__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  car_t265_interface__msg__T265Data * data = NULL;

  if (size) {
    data = (car_t265_interface__msg__T265Data *)allocator.zero_allocate(size, sizeof(car_t265_interface__msg__T265Data), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = car_t265_interface__msg__T265Data__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        car_t265_interface__msg__T265Data__fini(&data[i - 1]);
      }
...
car_t265_interface__msg__T265Data__Sequence__fini(car_t265_interface__msg__T265Data__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      car_t265_interface__msg__T265Data__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  car_t265_interface__msg__T265Data__Sequence * array = (car_t265_interface__msg__T265Data__Sequence *)allocator.allocate(sizeof(car_t265_interface__msg__T265Data__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = car_t265_interface__msg__T265Data__Sequence__init(array, size);
  if (!success) {
...
car_t265_interface__msg__T265Data__Sequence__destroy(car_t265_interface__msg__T265Data__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    car_t265_interface__msg__T265Data__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
car_t265_interface__msg__T265Data__Sequence__are_equal(const car_t265_interface__msg__T265Data__Sequence * lhs, const car_t265_interface__msg__T265Data__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!car_t265_interface__msg__T265Data__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  car_t265_interface__msg__T265Data__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(car_t265_interface__msg__T265Data);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    car_t265_interface__msg__T265Data * data =
      (car_t265_interface__msg__T265Data *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!car_t265_interface__msg__T265Data__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          car_t265_interface__msg__T265Data__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!car_t265_interface__msg__T265Data__copy(

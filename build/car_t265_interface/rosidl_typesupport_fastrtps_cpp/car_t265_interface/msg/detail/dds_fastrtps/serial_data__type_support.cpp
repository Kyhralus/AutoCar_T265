...
#include "car_t265_interface/msg/detail/serial_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const car_t265_interface::msg::SerialData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  car_t265_interface::msg::SerialData & ros_message)
{
  // Member: data
  {
    cdr >> ros_message.data;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = car_t265_interface::msg::SerialData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const car_t265_interface::msg::SerialData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<car_t265_interface::msg::SerialData *>(
    untyped_ros_message);
...
{
  return &car_t265_interface::msg::typesupport_fastrtps_cpp::_SerialData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, car_t265_interface, msg, SerialData)() {
  return &car_t265_interface::msg::typesupport_fastrtps_cpp::_SerialData__handle;
}

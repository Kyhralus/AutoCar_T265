...
#include "car_t265_interface/msg/detail/serial_data__rosidl_typesupport_fastrtps_c.h"
...
using _SerialData__ros_msg_type = car_t265_interface__msg__SerialData;
...
size_t get_serialized_size_car_t265_interface__msg__SerialData(
  const void * untyped_ros_message,
...
static uint32_t _SerialData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_car_t265_interface__msg__SerialData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_car_t265_interface
size_t max_serialized_size_car_t265_interface__msg__SerialData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = car_t265_interface__msg__SerialData;
    is_plain =
      (
...
static size_t _SerialData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_car_t265_interface__msg__SerialData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, car_t265_interface, msg, SerialData)() {

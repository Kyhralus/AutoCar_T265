...
static const _SendCommand_Request_type_support_symbol_names_t _SendCommand_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, car_t265_interface, srv, SendCommand_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, car_t265_interface, srv, SendCommand_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, car_t265_interface, srv, SendCommand_Request)() {
  return &::car_t265_interface::srv::rosidl_typesupport_c::SendCommand_Request_message_type_support_handle;
}
...
static const _SendCommand_Response_type_support_symbol_names_t _SendCommand_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, car_t265_interface, srv, SendCommand_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, car_t265_interface, srv, SendCommand_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, car_t265_interface, srv, SendCommand_Response)() {
  return &::car_t265_interface::srv::rosidl_typesupport_c::SendCommand_Response_message_type_support_handle;
}
...
static const _SendCommand_type_support_symbol_names_t _SendCommand_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, car_t265_interface, srv, SendCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, car_t265_interface, srv, SendCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, car_t265_interface, srv, SendCommand)() {
  return &::car_t265_interface::srv::rosidl_typesupport_c::SendCommand_service_type_support_handle;
}

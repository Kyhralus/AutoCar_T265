...
{
  new (message_memory) car_t265_interface::msg::SerialData(_init);
}

void SerialData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<car_t265_interface::msg::SerialData *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SerialData_message_member_array[1] = {
  {
    ...
    offsetof(car_t265_interface::msg::SerialData, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SerialData_message_members = {
  ...
  1,  // number of fields
  sizeof(car_t265_interface::msg::SerialData),
...
{
  return &::car_t265_interface::msg::rosidl_typesupport_introspection_cpp::SerialData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, car_t265_interface, msg, SerialData)() {
  return &::car_t265_interface::msg::rosidl_typesupport_introspection_cpp::SerialData_message_type_support_handle;
}
